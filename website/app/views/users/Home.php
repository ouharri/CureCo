...
<head>
    ...
    <!--    bootstrap  css-->
    <link rel="stylesheet" href="<?= url('css/plugins/bootstrap.min.css?v=') . time() ?>" type="text/css" media="all"/>

    <link rel="stylesheet" href="<?= url('css/plugins/bootstrap.min.css?v=') . time() ?>" type="text/css" media="all"/>
    <!--    cstm css-->
    <link rel="stylesheet" href="<?= url('css/style.css?v=') . time() ?>" type="text/css" media="all"/>
</head>
...
<script src="<?= url('js/js.js') . '?v=' . time() ?>"></script>
