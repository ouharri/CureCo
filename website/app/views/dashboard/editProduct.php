                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <form class="form px-3 py-1" method="post" enctype="multipart/form-data"
                                  action="<?= url('dashboard/editProduct') ?>/<?= $product['id'] ?? '' ?>">
                                            ...
                                            <select class="form-control" name="category" id="category">
                                                <?php if (isset($category)) {
                                                    foreach ($category as $ca) : ?>
                                                        <option value="<?= $ca['id'] ?>"
                                                            <?= ($product['category'] == $ca['libel']) ? 'selected' : '' ?> >
                                                            <?= $ca['libel'] ?>
                                                        </option>
                                                    <?php endforeach;
                                                } ?>
                                        ...
                                        <div class="form-group">
                                            <label for="barCode" class="form-control-label">
                                                ...
                                                <input class="barCode form-control" name="barCode" type="number"
                                                       ...
                                                       id="barCode" value="<?= $product['codeBar'] ?? '' ?>">
                                            </label>
                                            <i class="ion-ios-checkmark"></i>
                                            <i class="ion-android-alert"></i>
                                            <span></span>
                                ...
                                <div class="card-header px-0 pb-0 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-sm ms-2" name="">
                                        edit
                                    </button>
                                </div>
                            </form>
...
<script src="<?= url('js/dashboard/editProduct.js') . '?v=' . time() ?>"></script>
